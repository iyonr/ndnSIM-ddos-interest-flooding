...
try:
    ...
    pushback = InterestDdosAttack (name="attack-pushback",
                                    ...
                                    good  = 0,
                                    runs = range(1,2),
                                    folder = "attackDDoSPushback",
                                    producer = "gw",
                                    defaultRtt = "80ms")
    pushback.run ()

    SatisfactionMinManFigures (name="figureX", scenario=pushback).run ()
    SatisfactionNumberOfAttackersFigures (name="figureXX", scenario=pushback).run ()
