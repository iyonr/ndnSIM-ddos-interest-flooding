...
try:
    ...
    traceback = InterestDdosAttack (name="attack-traceback",
                                    ...
                                    good  = 0,
                                    runs = range(1,2),
                                    folder = "attackTraceback",
                                    producer = "gw",
                                    defaultRtt = "80ms")
    traceback.run ()

    SatisfactionMinManFigures (name="figureX", scenario=traceback).run ()
    SatisfactionNumberOfAttackersFigures (name="figureXX", scenario=traceback).run ()
