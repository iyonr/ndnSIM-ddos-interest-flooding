...
int main (int argc, char**argv)
{
  ...
  AppHelper evilAppHelper ("DdosAppMitigate");
  ...
  AppHelper goodAppHelper ("DdosAppMitigate");
  ...
  if (prefix == "traceback")
    {
      ...
      helper.SetForwardingStrategy ("ns3::ndn::fw::BestRoute::Stats::MitigateTraceback");
    }
  else
    {
